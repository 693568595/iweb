...
class character
{
    ...
    static $pack = array(
        "GetRoleData" => 0x1F43,  //获取角色XML
        "putRole" => 0x1F42,  //保存角色XML
        'GMListOnlineUser' => 0x160, //获取在线角色
        'GMKickoutRole' => 0x168, //角色禁止登录
        'GMShutupRole' => 0x16A, //角色禁止聊天
        'GMShutup' => 0x164, //账号禁止聊天
        'GMKickoutUser' => 0x162,  //账号禁止登录
        'GetUserRoles' => 0xD49, //获取账号角色
        'RenameRole' => 0xD4C, //修改角色名字
        'DeleteRole' => 0xBC0, //删除角色
        'DebugAddCash' => 0x209,  //添加元宝
        'SysSendMail' => 0x1076, //发送邮件
        'ChatBroadCast' => 0x78, //发送聊天
        'GMRestartServer' => 0x166, //重启服务器
        'GMGetGameAttri' => 0x178,  //获取服务器活动
        'GMSetGameAttri' => 0x179,  //设置服务器活动
        'CashPasswordSet' => 0x10A7, //设置元宝交易密码
        'IWebAutolockSet' => 0x185,   //禁用安全锁
    );

    static $attributes = array(
        'double_exp'   	=>0xCC,	// 204 双倍经验
        'double_sp'    	=>0xD5,	// 213 双倍元神
        'double_money' 	=>0xD3,	// 211 双倍金币
        'double_drop'	=>0xD4,	// 212 双倍掉落
        'forbid_trade'  =>0xCF,	// 207 禁止交易操作
        'forbid_auction'=>0xD0,	// 208 禁止拍卖操作
        'forbid_mail'   =>0xD1,	// 209 禁止邮件操作
        'forbid_faction'=>0xD2,	// 210 禁止帮派操作
        // 'GetLambda'   	=>0xCD,	// 205 并发连接数
        // 'NoSellPoint' 	=>0xD6,	// 214 禁止销售点卡
        // 'pvp' 			=>0xD7,	// 215 PVP开关
    );
